      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between gap-10">
          <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-xl flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4 mt-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">contato@unhasdamah.com.br</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              <a 
                ...
                className="bg-primary text-white px-6 py-3 rounded-full inline-block hover:bg-pink-600 transition-colors"
              >
                Ver no Google Maps
              </a>
            </div>
          ...
          <div className="md:w-1/2 h-64 md:h-auto rounded-lg overflow-hidden shadow-xl">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.1675089782906!2d-46.65882422554006!3d-23.56300417882249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0xd59f9431f2c9776a!2sAv.%20Paulista%20-%20Bela%20Vista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1682097929011!5m2!1spt-BR!2sbr" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
